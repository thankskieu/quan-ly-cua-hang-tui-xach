...
<head>
    <meta charset="UTF-8">
    <title>Tra cứu vận đơn • CHAUTFIFTH</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-4 md:p-8 flex-grow flex flex-col items-center">
        <div class="w-full max-w-4xl">
            <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Tra cứu hành trình đơn hàng</h1>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="space-y-3 text-sm">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-700"><?= preg_replace('/(?<=.).(?=.*@)/', '*', $shipment['customer_email']) ?></p>
                                </div>
                                <?php endif; ?>
                                <div>
